...
\begin{figure}[H]
    \begin{center}
        \subfloat[Pearson correlation heatmap RAW]{\includegraphics[width = 320pt]{img/pearson_correlation/raw_heatmap.png}}
    \end{center}
\end{figure}
...
\begin{figure}[H]
    \begin{center}
        \subfloat[Pearson correlation heatmap PCA]{\includegraphics[width = 320pt]{img/pearson_correlation/pca_heatmap.png}}
    \end{center}
\end{figure}
...
%TODO: CHECK THIS and improve it
