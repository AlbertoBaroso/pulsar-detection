...
from models.train import mvg_kfold, logistic_regression_kfold, gmm_kfold
...
if __name__ == "__main__":
    ...
    for steps in range(1, 5):
        ...
        validated_mvg_models = gmm_kfold(DTR_kfold_raw, LTR_kfold, DVAL_kfold_raw, LVAL, class_priors, steps)
