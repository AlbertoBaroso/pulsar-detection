...
if __name__ == '__main__':
    ...
    gaussianized_training_samples = gaussianize_training_samples(
        training_samples)
    gaussianized_test_samples = gaussianize_test_samples(
        test_samples, training_samples)

    for i in range(len(features)):
        plot_feature_histogram(
            features[i], gaussianized_training_samples[i], training_labels)
        plot_feature_histogram(
            features[i], gaussianized_test_samples[i], test_labels)
